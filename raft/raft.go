...
func (r *Raft) handleSnapshot(m pb.Message) {
	...
	//	nxtIndex := r.RaftLog.GetRealIndex(m.Snapshot.Metadata.Index) + 1
	//	newEntries = append(newEntries, r.RaftLog.entries[nxtIndex:]...)
	//}
