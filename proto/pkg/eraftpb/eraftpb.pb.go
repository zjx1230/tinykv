...
const (
	...
	EntryType_EntryApply      EntryType = 1
...
func (EntryType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_e433d35547a8236d, []int{0}
}
...
func (MessageType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_e433d35547a8236d, []int{1}
}
...
func (ConfChangeType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_e433d35547a8236d, []int{2}
}
...
type Message struct {
	...
	NeedSnapshot         bool        `protobuf:"varint,11,opt,name=needSnapshot,proto3" json:"needSnapshot,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (*Message) Descriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_e433d35547a8236d, []int{3}
}
...
func (m *Message) GetNeedSnapshot() bool {
	if m != nil {
		return m.NeedSnapshot
	}
	return false
}
...
func (*HardState) Descriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_e433d35547a8236d, []int{4}
}
...
func (*ConfState) Descriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_e433d35547a8236d, []int{5}
}
...
func (*ConfChange) Descriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_e433d35547a8236d, []int{6}
}
...
func (m *Message) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NeedSnapshot", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func init() { proto.RegisterFile("eraftpb.proto", fileDescriptor_eraftpb_e433d35547a8236d) }

var fileDescriptor_eraftpb_e433d35547a8236d = []byte{
	// 684 bytes of a gzipped FileDescriptorProto
	,
}
